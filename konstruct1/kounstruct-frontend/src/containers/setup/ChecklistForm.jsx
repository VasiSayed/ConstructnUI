...
import { createChecklist, updateChecklist } from "../../api";
...
const ChecklistForm = ({
  ...
  const handleQuestionOptionChange = (
    ...
    // Ensure the options array exists for this question
    if (!updatedQuestions[questionIndex].options) {
      updatedQuestions[questionIndex].options = [];
    }

    // Create a new copy of the option to modify
    const updatedOption = {
      ...updatedQuestions[questionIndex].options[optionIndex],
      [field]: value,
    };

    // Update just this specific question's option
    updatedQuestions[questionIndex].options = [
